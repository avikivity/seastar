...
reactor::reactor(unsigned id)
    ...
    , _at_destroy_tasks(1, "atexit", 100)
...
reactor::run_some_tasks(sched_clock::time_point& t_run_completed) {
    ...
    do {
        ...
        sched_print("run complete ({} {}); time consumed %d usec; final vruntime %d empty %d\n",
