...
class unix_connected_socket_operations : public posix_connected_socket_operations {
public:
...
static unix_connected_socket_operations unix_connected_socket_ops;

class posix_connected_unix_socket_impl final : public connected_socket_impl {
    lw_shared_ptr<pollable_fd> _fd;
    conntrack::handle _handle;
    compat::polymorphic_allocator<char>* _allocator;
    const posix_connected_socket_operations* _ops = &unix_connected_socket_ops;
