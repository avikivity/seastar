...
public:
    ...
    virtual future<size_t> write_some(pollable_fd_state& fd, const ::iovec* iov, size_t niov) = 0;
...
public:
    ...
    virtual future<size_t> write_some(pollable_fd_state& fd, const ::iovec* iov, size_t niov) override;
